$(document).ready(function () {
    ...
    $('.medicine-bill-view').on('click', function () {
        $('.medicine-bill-modal').removeClass('hidden').addClass('flex');
    });

    $('.close-medicine-bill').on('click', function () {
        $('.medicine-bill-modal').removeClass('flex').addClass('hidden');
    });
